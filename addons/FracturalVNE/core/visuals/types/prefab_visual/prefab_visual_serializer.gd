...
func serialize(object):
	return {
		...
		"prefab_path": object.prefab_path,
...
func deserialize(serialized_object):
	var visual_prefab = load("res://addons/FracturalVNE/core/visuals/types/prefab_visual/prefab_visual.tscn")
	
	var instance = visual_prefab.instance()
	
	instance.init_(story_director, serialized_object["prefab_path"])
...
func _script_path():
	return "res://addons/FracturalVNE/core/visuals/types/prefab_visual/prefab_visual.gd"
