...
func serialize(object):
	return {
		...
		"texture_path": object.texture.get_path(),
...
func deserialize(serialized_object):
	...
	instance.init_(story_director, load(serialized_object["texture_path"]))
...
func _script_path():
	return "res://addons/FracturalVNE/core/visuals/types/single_visual/single_visual.gd"
