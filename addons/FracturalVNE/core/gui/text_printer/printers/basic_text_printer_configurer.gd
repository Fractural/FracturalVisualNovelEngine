extends Node
# Configures the BasicTextPrinter with certain settings.
# The configuring must be done through a script like this because Godot does 
# not support creating custom classes (like CharactersDelay) in the inspector.
