...
namespace MonoCustomResourceRegistry
{
	public static class Settings
	{
		...
		public static bool RefreshCustomResourceOnBuild => (bool) GetSettings(nameof(RefreshCustomResourceOnBuild));

		public static void Init()
		{
			AddSetting(nameof(ClassPrefix), Variant.Type.String, "");
			AddSetting(nameof(RefreshCustomResourceOnBuild), Variant.Type.Bool, true);
